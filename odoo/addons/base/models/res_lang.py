...
class Lang(models.Model):
    ...
    _name_uniq = models.Constraint(
        'unique(name)',
        lambda env: env._('The name of the language must be unique!'),
    )
    _code_uniq = models.Constraint(
        'unique(code)',
        lambda env: env._('The code of the language must be unique!'),
    )
    _url_code_uniq = models.Constraint(
        'unique(url_code)',
        lambda env: env._('The URL code of the language must be unique!'),
    )
