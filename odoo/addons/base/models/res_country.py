...
class Country(models.Model):
    ...
    _name_uniq = models.Constraint(
        'unique (name)',
        lambda env: env._('The name of the country must be unique!'),
    )
    _code_uniq = models.Constraint(
        'unique (code)',
        lambda env: env._('The code of the country must be unique!'),
    )
...
class CountryState(models.Model):
    ...
    _name_code_uniq = models.Constraint(
        ...
        lambda env: env._('The code of the state must be unique by country!'),
    )
