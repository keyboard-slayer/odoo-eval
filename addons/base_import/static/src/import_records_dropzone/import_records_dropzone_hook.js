...
/** @param {Object} targetRef */
export function useImportRecordsDropzoneOnExternalViews (targetRef) {
    const component = useComponent();
    const actionService = useService("action");
    const { context, resModel } = component.env.searchModel;
    useImportRecordsDropzone(targetRef, resModel, async file => {
