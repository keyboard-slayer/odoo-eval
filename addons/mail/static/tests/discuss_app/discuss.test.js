...
test("Chats input should wait until the previous RPC is done before starting a new one", async () => {
    ...
    await start();
    await openDiscuss();
    await insertText(".o-mail-DiscussSearch input", "m");
    await contains(".o-mail-NavigableList-floatingLoading", { text: "Loading…" });
    await insertText(".o-mail-DiscussSearch input", "a");
    await insertText(".o-mail-DiscussSearch input", "r");
    deferred1.resolve();
    await Promise.resolve();
    await assertSteps(["First RPC"]);
    deferred2.resolve();
    await contains(".o-mail-DiscussSearch-suggestion", { text: "Mario" });
    await contains(".o-mail-DiscussSearch-suggestion", { count: 0, text: "Mama" });
...
test("Newly created chat should be at the top of the direct message list", async () => {
    ...
    await start();
    await openDiscuss();
    await insertText(".o-mail-DiscussSearch input", "Jer");
    await click(".o-mail-DiscussSearch-suggestion", { text: "Jerry Golay" });
