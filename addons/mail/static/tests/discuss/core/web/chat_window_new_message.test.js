...
test("basic rendering", async () => {
    ...
    await contains(".o-mail-DiscussSearch");
});
...
test("focused on open [REQUIRE FOCUS]", async () => {
    ...
    await click(".o_menu_systray i[aria-label='Messages']");
    await click("button", { text: "New Message" });
    await contains(".o-mail-ChatWindow .o-mail-DiscussSearch input:focus");
});
...
test('open chat from "new message" chat window should open new chat', async () => {
    ...
    await contains(".o-mail-ChatWindow .o-mail-DiscussSearch");
    // open channel-2
    await click(".o_menu_systray i[aria-label='Messages']");
    ...
    await insertText(".o-mail-DiscussSearch input", "131");
    await click(".o-mail-DiscussSearch-suggestion a", { text: "Partner 131" });
...
test("new message chat window should close on selecting the user if chat with the user is already open", async () => {
    ...
    await click("button", { text: "New Message" });
    await insertText(".o-mail-DiscussSearch input", "131");
    await click(".o-mail-DiscussSearch-suggestion a");
    await contains(".o-mail-ChatWindow", { count: 0, text: "New message" });
    await contains(".o-mail-ChatWindow");
});
...
test("new message autocomplete should automatically select first result", async () => {
    ...
    await click("button", { text: "New Message" });
    await insertText(".o-mail-DiscussSearch input", "131");
    await contains(".o-mail-DiscussSearch-suggestion a.o-mail-NavigableList-active");
});
