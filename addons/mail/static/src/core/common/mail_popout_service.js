...
export const mailPopoutService = {
    start(env) {
        ...
        /**
         * Resets the external window then
         * Mounts the passed component (with its props) on the external window
         * @param {ComponentConstructor} component: The component to be mounted
         * @param {Props} props: The props of the component
         */
        function update(component, props) {
            reset();
         ...
         */
        function popout(component, props, beforePopout = () => {}, afterPopout = () => {}) {
