...
class AccountMove(models.Model):
    ...
    def _get_discount_amount_jod(self):
        ...
        for line in self.invoice_line_ids:
            discount_amount += line._get_discount_amount_jod()
...
class AccountMoveLine(models.Model):
    ...
    def _get_discount_amount_jod(self):
        ...
        discount_amount = 0
        if self.discount != 0:
            discount_amount = self.price_subtotal * (self.discount / (100 - self.discount))
        return discount_amount / (self.currency_rate or 1)
