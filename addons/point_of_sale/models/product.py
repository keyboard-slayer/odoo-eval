...
class ProductProduct(models.Model):
    ...
    def _add_missing_products(self, products, config_id, data):
        ...
        products.extend(self._load_product_with_domain([('id', 'in', list(not_loaded_product_ids))], config_id))

    def _load_product_with_domain(self, domain, config_id):
        fields = self._load_pos_data_fields(config_id)
        context = {**self.env.context, 'display_default_code': False, 'active_test': False}
