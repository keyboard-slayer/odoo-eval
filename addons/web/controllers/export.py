...
class Export(http.Controller):
    ...
    def get_fields(self, model, prefix='', parent_name='',
        ...
        property_fields = {}
        # Add virtual properties field
        for fname, field in exportable_fields.items():
            ...
            # TODO: Do we want archive record or not ? Maybe it should depends of the
            # search view at this state but it seems complicated. Let the caller choose.
        ...
        exportable_fields.update(property_fields)
