...
""",
    ...
    'assets': {
        ...
        'web.assets_frontend_minimal': [
            ...
            # Added bootsrap files to mininal bundle
            'web/static/lib/popper/popper.js',
            'web/static/lib/bootstrap/js/dist/util/index.js',
            'web/static/lib/bootstrap/js/dist/dom/data.js',
            'web/static/lib/bootstrap/js/dist/dom/event-handler.js',
        ...
        'web.assets_frontend': [
            ...
            # Moved bootsrap files to minimal Bundle
            'web/static/src/libs/bootstrap.js',
        ...
        'web.assets_frontend_lazy': [
            ...
            ('remove', 'web/static/lib/popper/popper.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/util/index.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/dom/data.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/dom/event-handler.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/dom/manipulator.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/dom/selector-engine.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/util/config.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/util/component-functions.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/util/backdrop.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/util/focustrap.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/util/sanitizer.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/util/scrollbar.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/util/swipe.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/util/template-factory.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/base-component.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/alert.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/button.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/carousel.js'),
            ('remove', 'web/static/lib/bootstrap/js/dist/collapse.js'),
            ...
            ('remove', 'web/static/lib/bootstrap/js/dist/toast.js'),
