...
class HrExpenseSheet(models.Model):
    ...
    def _do_refuse(self, reason):
        if any(self.mapped('account_move_ids')):  # Todo: in 17.3+, edit it to allow draft entries"
            raise UserError("You cannot cannot cancel an expense linked to a journal entry")
