...
class HrExpense(models.Model):
    ...
    def _compute_total_amount_currency(self):
        ...
        for expense in self.filtered('product_has_cost'):
            ...
            AccountTax._add_base_line_tax_details(base_line, expense.company_id)
    ...
    def _prepare_payments_vals(self):
        ...
        AccountTax._add_base_lines_accounting_tax_details(base_lines, self.company_id, include_caba_tags=self.payment_mode == 'company_account')
