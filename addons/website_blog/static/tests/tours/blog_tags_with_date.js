...
wTourUtils.registerWebsitePreviewTour("blog_tags_with_date", {
    ...
    ...wTourUtils.clickOnSave(),
    {
        ...
        content: "Check 'adventure' tag is present after addition of date filter",
        trigger: "#o_wblog_posts_loop span:contains('adventure')",
        isCheck: true,
    }, {
        content: "Check 'discovery' tag is present after addition of date filter",
        trigger: "#o_wblog_posts_loop span:contains('discovery')",
        isCheck: true,
    }, {
        ...
        content: "Check 'adventure' tag is present after removal of date filter",
        trigger: "#o_wblog_posts_loop span:contains('adventure')",
        isCheck: true,
    }, {
        content: "Check 'discovery' tag is present after removal of date filter",
        trigger: "#o_wblog_posts_loop span:contains('discovery')",
        isCheck: true,
    }]
);
