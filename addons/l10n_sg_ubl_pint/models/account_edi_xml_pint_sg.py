...
class AccountEdiXmlUBLPINTSG(models.AbstractModel):
    ...
    * PINT SG Official documentation: https://docs.peppol.eu/poac/sg/2024-Q2/pint-sg/
    ...
    def _export_invoice_vals(self, invoice):
        ...
        vals.update({
            'InvoiceType_template': 'l10n_sg_ubl_pint.ubl_21_InvoiceType_sg',
            'CreditNoteType_template': 'l10n_sg_ubl_pint.ubl_21_CreditNoteType_sg',
            'DebitNoteType_template': 'l10n_sg_ubl_pint.ubl_21_CreditNoteType_sg',
        })
        ...
        vals['vals'].update({
            ...
            'l10n_sg_ubl_pint_uuid': invoice._l10n_sg_get_uuid(),
        })
    ...
    def _export_invoice_constraints(self, invoice, vals):
        ...
        for tax_total_val in vals['vals']['tax_total_vals']:
            for tax_subtotal_val in tax_total_val['tax_subtotal_vals']:
                ...
                if tax_category_vals['tax_category_code'] not in SG_TAX_CATEGORIES:
