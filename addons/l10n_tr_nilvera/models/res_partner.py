...
class ResPartner(models.Model):
    ...
    l10n_tr_nilvera_customer_alias = fields.Char(
        string='Alias',
        compute='_compute_nilvera_customer_status',
        store=True,
        copy=False,
    ...
    def _compute_nilvera_customer_status(self):
        for partner in self:
            if partner.vat and partner.ubl_cii_format == 'ubl_tr':
                ...
                partner.l10n_tr_nilvera_customer_alias = False
    ...
    def check_nilvera_customer(self):
        ...
        if response.status_code == 200:
            ...
            if not query_result:
                ...
                self.l10n_tr_nilvera_customer_alias = False
            else:
                self.l10n_tr_nilvera_customer_status = 'einvoice'
                self.l10n_tr_nilvera_customer_alias = query_result[0].get('Name')
