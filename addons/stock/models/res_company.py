...
class Company(models.Model):
    ...
    def create_missing_inventory_loss_location(self):
        ...
        companies_having_property = self.env['ir.property'].sudo().search([('fields_id', '=', inventory_loss_product_template_field.id), ('res_id', '=', False)]).company_id
    ...
    def create_missing_production_location(self):
        ...
        companies_having_property = self.env['ir.property'].sudo().search([('fields_id', '=', production_product_template_field.id), ('res_id', '=', False)]).company_id
        company_without_property = company_ids - companies_having_property
