...
class StockWarehouseOrderpoint(models.Model):
    ...
    _qty_multiple_check = models.Constraint(
        ...
        lambda env: env._('Qty Multiple must be greater than or equal to zero.'),
    )
    _product_location_check = models.Constraint(
        'unique (product_id, location_id, company_id)',
        lambda env: env._('A replenishment rule already exists for this product on this location.'),
    )
