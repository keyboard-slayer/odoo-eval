...
class AccountEdiXmlUBLPINTANZ(models.AbstractModel):
    ...
    * PINT ANZ Official documentation: https://docs.peppol.eu/poac/aunz/pint-aunz/
    ...
    def _get_tax_unece_codes(self, invoice, tax):
        ...
        if not supplier.vat:
            return 'O'  # a business is not registered for GST, the business cannot issue tax invoices. In this case, the GST category code should be O (Outside scope of tax).
