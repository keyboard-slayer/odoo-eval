...
class ProductTemplate(models.Model):
    ...
    l10n_my_edi_classification_code = fields.Selection(
        ...
        selection=[
            ...
            (
                "038",
                "Fees related to sports equipment, facility rentals, competition registration, and training imposed by registered sports organizations under the Sports Development Act 1997 in Malaysia",
            ),
