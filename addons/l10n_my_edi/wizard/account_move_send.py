...
class AccountMoveSend(models.TransientModel):
    ...
    l10n_my_edi_generate_file_checkbox = fields.Boolean(
        compute='_compute_l10n_my_edi_generate_file_checkbox',
        string='Generate MyInvois file',
        readonly=False,
        store=True,
    )
    ...
    def _get_wizard_values(self):
        ...
        values['l10n_my_edi_generate'] = self.l10n_my_edi_generate_file_checkbox
        return values
    ...
    def _compute_l10n_my_edi_generate_file_checkbox(self):
        for wizard in self:
            wizard.l10n_my_edi_generate_file_checkbox = wizard.l10n_my_edi_enable
