...
class TestTaxesTaxTotalsSummary(TestTaxCommon):
    ...
    def test_taxes_l10n_br(self):
        ...
        tax7 = self.division_tax(20, price_include=True)
        tax8 = self.division_tax(20, price_include=True)
        taxes += tax7 + tax8
    ...
    def test_taxes_l10n_mx(self):
        tax = self.percent_tax(16, price_include=True)
    ...
    # TODO: STPA test with discounts & round_globally
