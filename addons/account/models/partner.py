...
class AccountFiscalPositionTax(models.Model):
    ...
    _tax_src_dest_uniq = models.Constraint(
        ...
        lambda env: env._('A tax fiscal position could be defined only one time on same taxes.'),
    )
...
class AccountFiscalPositionAccount(models.Model):
    ...
    _account_src_dest_uniq = models.Constraint(
        ...
        lambda env: env._('An account fiscal position could be defined only one time on same accounts.'),
    )
