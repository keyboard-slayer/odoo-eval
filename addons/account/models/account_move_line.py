...
class AccountMoveLine(models.Model):
    ...
    _check_credit_debit = models.Constraint(
        ...
        lambda env: env._('Wrong credit or debit value in accounting entry!'),
    )
    _check_amount_currency_balance_sign = models.Constraint(
        ...
        lambda env: env._('The amount expressed in the secondary currency must be positive when account is debited and negative when account is credited. If the currency is the same as the one from the company, this amount must strictly be equal to the balance.'),
    )
    _check_accountable_required_fields = models.Constraint(
        ...
        lambda env: env._('Missing required account on accountable line.'),
    )
    _check_non_accountable_fields_null = models.Constraint(
        ...
        lambda env: env._('Forbidden balance or account on non-accountable line'),
    )
