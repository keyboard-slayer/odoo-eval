...
class AccountReportLine(models.Model):
    ...
    _code_uniq = models.Constraint(
        ...
        lambda env: env._('A report line with the same code already exists.'),
    )
...
class AccountReportExpression(models.Model):
    ...
    _domain_engine_subformula_required = models.Constraint(
        ...
        lambda env: env._("Expressions using 'domain' engine should all have a subformula."),
    )
    _line_label_uniq = models.Constraint(
        'UNIQUE(report_line_id,label)',
        lambda env: env._('The expression label must be unique per report line.'),
    )
