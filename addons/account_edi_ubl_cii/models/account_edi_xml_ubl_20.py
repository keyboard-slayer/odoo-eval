...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _get_postal_address(self, tree, role):
        return {
            'street': self._find_value(f'.//cac:Accounting{role}Party/cac:Party/cac:PostalAddress/cbc:StreetName', tree),
            'additional_street': self._find_value(f'.//cac:Accounting{role}Party/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName', tree),
            'city': self._find_value(f'.//cac:Accounting{role}Party/cac:Party/cac:PostalAddress/cbc:CityName', tree),
            'zip': self._find_value(f'.//cac:Accounting{role}Party/cac:Party/cac:PostalAddress/cbc:PostalZone', tree),
            'state_code': self._find_value(f'.//cac:Accounting{role}Party/cac:Party/cac:PostalAddress/cbc:CountrySubentityCode', tree),
        }
