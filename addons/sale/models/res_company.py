...
class ResCompany(models.Model):
    ...
    _check_quotation_validity_days = models.Constraint(
        ...
        lambda env: env._('You cannot set a negative number for the default quotation validity. Leave empty (or 0) to disable the automatic expiration of quotations.'),
    )
