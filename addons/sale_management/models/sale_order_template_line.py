...
class SaleOrderTemplateLine(models.Model):
    ...
    _accountable_product_id_required = models.Constraint(
        ...
        lambda env: env._('Missing required product and UoM on accountable sale quote line.'),
    )
    _non_accountable_fields_null = models.Constraint(
        ...
        lambda env: env._('Forbidden product, quantity and UoM on non-accountable sale quote line'),
    )
