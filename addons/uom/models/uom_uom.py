...
class UoM(models.Model):
    ...
    labellable = fields.Boolean('labellable', default=lambda self: self._default_labellable(), help="Print 1 product label per unit transferred")
