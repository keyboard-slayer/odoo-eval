...
class SlidesPortalChatter(PortalChatter):
    ...
    def portal_chatter_post(self, thread_model, thread_id, post_data, **kw):
        ...
        result = super(SlidesPortalChatter, self).portal_chatter_post(thread_model, thread_id, post_data, **kw)
    ...
    def mail_update_message(self, thread_model, thread_id, message_id, post_data, **kwargs):
